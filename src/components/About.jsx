          ...
          <div class="flex gap-2">
            ...
            <div className="group relative cursor-pointer items-center justify-center overflow-hidden transition-shadow hover:shadow-xl rounded-xl hover:shadow-black/30">
              ...
              <div className="absolute inset-0 flex translate-y-[60%] flex-col items-center justify-center px-9 text-center transition-all duration-500 group-hover:translate-y-0">
                ...
                <p className="mb-3 text-[14px] italic text-white opacity-0 transition-opacity duration-300 group-hover:opacity-100">
                  Eager To Implement Knowledge Into Contributing TO Information
                  Technology
                </p>
                <button className="rounded-full bg-neutral-900 py-2 px-3.5 font-com text-sm capitalize text-white shadow shadow-black/60">
  ...
  <div>
    <div class="flex w-full min-h-screen items-center justify-center bg-neutral-800 main">
      <div class="grid gap-5 ">
        ...
        >
          ...
          <div class="absolute inset-0 flex translate-y-[60%] flex-col items-center justify-center px-9 text-center transition-all duration-500 group-hover:translate-y-0">
            ...
            <p class="mb-3 text-[14px] italic text-white opacity-0 transition-opacity duration-300 group-hover:opacity-100">
              Impleteing The knowledge Into The Real World Application{" "}
            </p>
        ...
        >
          ...
          <div class="absolute inset-0 flex translate-y-[60%] flex-col items-center justify-center px-9 text-center transition-all duration-500 group-hover:translate-y-0">
            ...
            <p class="mb-3 text-[14px] italic text-white opacity-0 transition-opacity duration-300 group-hover:opacity-100">
              Eager To apply Knowledge To The Real World Application
            </p>
            <button class="rounded-full bg-neutral-900 py-2 px-3.5 font-com text-sm capitalize text-white shadow shadow-black/60">
              <a
                href="https://www.linkedin.com/in/nikhil-jha-145793239/"
                target="_blank"
              >
                See More
              </a>
      ...
      <div
        className={`${
          toggle ? "hidden" : ""
        } border-2 mx-4 bg-[#460658] text-white rounded-xl font-bold px-4 py-2 my-4 `}
      >
        ...
        <p className="text-[#dfd9ff] font-medium lg:text-[30px] sm:text-[26px] xs:text-[20px] text-[16px] lg:leading-[40px]">
          ...
          <br />I develop 3D web applications.
        </p>
      ...
      <button
        ...
        className=" fixed bottom-10 bg-[#460658] text-white hover:bg-white hover:text-black font-bold border-2 px-4 py-2 rounded-xl"
      >
        Switch
      </button>
      <StarsCanvas />
